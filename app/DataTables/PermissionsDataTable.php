...
class PermissionsDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('group_name')->orderable(true)->addClass('sorting'),
