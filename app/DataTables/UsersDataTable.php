...
class UsersDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('email')->orderable(true)->addClass('sorting'),
            Column::make('created_at')->orderable(true)->addClass('sorting'),
