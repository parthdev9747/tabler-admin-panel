...
class CaseCategoriesDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\CaseCategory $model
    ...
    {
        return $this->builder()
            ->setTableId('case-categories-table')
    ...
    {
        return 'CaseCategories_' . date('YmdHis');
    }
}
